...
import mvcPatternImage from "../../assets/posts/MVCPattern.png";
...
<Image src={mvcPatternImage} width={800} height={600} alt="A digram showing how the MVC layers interact" />
...
Lets look at some pseudo code for this controller:
...
Let's look at some pseudo code for the `User` model:
