...
import portfolioV1LandingImage from "../../assets/posts/PortfolioV1Landing.png";
import portfolioV1AboutImage from "../../assets/posts/PortfolioV1About.png";
import portfolioV1ProjectsImage from "../../assets/posts/PortfolioV1Projects.png";
import portfolioV2LandingImage from "../../assets/posts/PortfolioV2Landing.png";
...
<Image src={portfolioV1LandingImage} width={800} height={600} alt="The landing page of my first portfolio website" />
...
<Image src={portfolioV1AboutImage} width={800} height={600} alt="The about page of my first portfolio website" />

<Image src={portfolioV1ProjectsImage} width={800} height={600} alt="The projects page of my first portfolio website" />
...
<Image src={portfolioV2LandingImage} width={800} height={600} alt="The landing page of my second portfolio website" />
...
This version still uses React but only whitin [Astro](https://astro.build/) which greatly increases performance and also removes much of the overhead that comes with a traditional React SPA application. An other interesting technicality is that I also use MDX for the blog posts in the brand new blog section.
